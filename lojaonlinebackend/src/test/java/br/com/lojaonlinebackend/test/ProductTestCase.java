...
public class ProductTestCase {
	...
	public static void init() {
		...
		context.refresh();
		productDAO = (ProductDAO) context.getBean("produtoDAO");
	}
	...
	public void testCRUDProduct() {
		...
		product.setDescription("This is some description forOppo");
		...
		assertEquals("Something went wrong while deleting the existing record!", true, productDAO.update(product));

		assertEquals("Something went wrong while fetching the lidt of products", 6, productDAO.list().size());
	...
	public void testListActiveProducts() {
		assertEquals("Something went wrong while fetching the list of products active!", 5, productDAO.listActiveProducts().size());
